  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Withdraw Users - Failed</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Withdraw Users - Failed</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Withdraw Users - Failed
                </h3>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $query = "SELECT a.id as idrequest, b.id, a.uid, a.firstname,  b.profile_pic, a.lastname, b.full_name, b.short_digital_id, b.uid, a.payment_method, a.bank_address, a.iban, a.swiftcode, a.western_union_details, a.country, a.phone, a.amount, a.dollarsamount, a.status, a.submission_time FROM withdraw_request AS a INNER JOIN users AS b ON a.uid = b.uid WHERE a.status = 'failed';";
