...
<!-- Delete Admin -->
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Feedback List
                </h3>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $query = "SELECT a.id as idfeed, b.id, a.user, a.type,  b.profile_pic, a.problem_description, b.full_name, b.short_digital_id, b.uid, a.reply, a.reply_rate FROM feedback AS a INNER JOIN users AS b ON a.user = b.uid WHERE a.id";
