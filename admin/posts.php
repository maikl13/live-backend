        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" name="DeletePostbtn" class="btn btn-danger">Yes, Delete !</button>
      </div>
    </form>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td><?php echo $row['id']; ?></td>
                    <td><?php echo $row['publisher_uid']; ?></td>
                    <td><?php echo $row['text']; ?></td>
                    <td><?php echo $row['datetime']; ?></td>
                    <td>
                    <a href="post-edit.php?user_id=<?php echo $row['id']; ?>" class="btn btn-info">Edit</a>
                    <a href="code/code-posts.php?post_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
