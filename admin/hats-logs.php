...
<!-- Delete Admin -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Hats Logs</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Hats Logs List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Hats Logs List
                </h3>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                //    $query = "SELECT * FROM users_bought_themes";
                    $query = "SELECT a.id as idhat, b.id, a.user_uid, a.hat, b.profile_pic, b.full_name, b.uid, a.stock FROM users_hats AS a INNER JOIN users AS b ON a.user_uid = b.uid WHERE a.id";
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        foreach($query_run as $row)
                        {
                          ?>
                  <tr>
                  <td><?php echo $row['idhat']; ?></td>
                  <td><img src="../images/<?php echo $row['profile_pic']; ?>" width="70" height="70" /></td>
                  <td><?php echo $row['user_uid']; ?>(<?php echo $row['full_name']; ?>)</td>
                  <td><?php echo $row['hat']; ?></td>
                  <td><?php echo $row['stock']; ?></td>
                    <td>
                    <button type="button" value="<?php echo $row['idhat']; ?>" class="btn btn-danger deletebtn">Delete</a>
                    </td>
                  </tr>
