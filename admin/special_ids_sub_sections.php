...
<!-- Delete Admin -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Special ID Sub Category List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Special ID SUB Category List
                </h3>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $query = "SELECT a.id as id_subcate, b.id as cateid, a.title, a.father_section, a.pattern, b.title as catename, a.price FROM special_ids_sub_sections AS a INNER JOIN special_ids_sections AS b ON a.father_section = b.id WHERE a.father_section";
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="special_ids_sub_sections-edit.php?specialidsubcategory=<?php echo $row['id_subcate']; ?>" class="btn btn-info"><i class="editicon"></i>  Edit</a>
                    </td>
                  </tr>
